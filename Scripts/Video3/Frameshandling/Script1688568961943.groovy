...
WebUI.click(findTestObject('Object Repository/Page_Capabilities/a_NoFrames'))

WebUI.click(findTestObject('Object Repository/Page_Capabilities/a_Frames'))

WebUI.click(findTestObject('Object Repository/Page_Capabilities/h2_Interface Capabilities'))
